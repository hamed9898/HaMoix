...
<p align="center">
  <img src="images.jpeg" alt="پیش‌نمایش داشبورد مدیریت Hamoix" width="100%">
</p>

> تصویر بالا یک نمای نمونه از داشبورد مدیریت Hamoix است؛ برای مشاهده‌ی امکانات کامل و نصب پنل، راهنمای نصب پایین صفحه را دنبال کنید.
